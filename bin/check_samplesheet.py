...
### edited from: https://github.com/nf-core/rnavar/blob/1.0.0/bin/check_samplesheet.py
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            group_col (str): The name of the new column that will be used for differential gene
            	expression analysis (default "group").
...
def check_samplesheet(file_in, file_out):
    ...
    """
    required_columns = {"sample", "fastq_1", "fastq_2","group"}
